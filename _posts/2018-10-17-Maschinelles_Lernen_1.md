...
<div style="background-color: #EAEFF4; border: 1px solid #b5aeb1; border-radius: 3px;  padding: 10px; margin-right: 10px">
   ...
   <strong>Einordnung:</strong> Vertiefungsfach "Anthropomatik und Kognitive Systeme", Profil "Datenintensives Rechnen" <br>
</div>
...
- **28.01.2019**: Übung 06 Unüberwachtes Lernverfahren
...
Wissen abspeichern und übertragem, Kreativität und Bewusstsein, Überleben in komplexen Welten, Rezeptive und 
...
**Inferenz**: bezeichnet den Vorgang eines Algorithmus aus Fakrent und Vermutung (korrekte) Schlüsse zu ziehen.
...
**Historie**: 
- *Beginn und Enthusiasmus (1955-1968):* Lernen ohne Wissenstrukturen, Auswendig Lernen und Lernen als Suche,...
- *Depression (1969-1976):* Symbolisches begrifforientiertes Lernen,...
- *Rennaissance (1976-1986):* erste erfolgreiche Anwendung, Neuronale Netze, Statistisches Lernen,...
- *Maturität - Reife (1986-...):* Reinforcement Learning, Deep Learning, Kombination induktiver und deduktiver Verfahren,...
- *Heute:* Betrachtung komplexere realer Anwendungen, Verbesserung/Erweiterung der Grundverfahren
...
**Induktive Lernverfahren**: beispiel Konzeptlernen  
Gegeben:
...
- *Präferenzbiars*: h mit höchste Präferenz in geordnetem Hypothesenraum  
